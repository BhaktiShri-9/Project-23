...
function setup(){
    ...
    particle2 = Bodies.circle(220,10,12,particle_options);
    World.add(world,particle2);
    particle3 = Bodies.circle(225,10,9,particle_options);
    World.add(world,particle3);
    particle4 = Bodies.circle(230,10,13,particle_options);
    World.add(world,particle4);
    particle5 =Bodies.circle(235,10,8,particle_options);
    World.add(world,particle5);
    particle6 =Bodies.circle(240,10,14,particle_options);
    World.add(world,particle6);
    particle7 =Bodies.circle(245,10,7,particle_options);
    World.add(world,particle7);
    particle8 =Bodies.circle(250,10,15,particle_options);
    World.add(world,particle8);
    particle9 =Bodies.circle(255,10,6,particle_options);
    World.add(world,particle9);
    particle10 =Bodies.circle(260,10,16,particle_options);
...
function draw(){
  ...
  ellipse(particle3.position.x,particle3.position.y,9);
  ellipse(particle4.position.x,particle4.position.y,13);
  ellipse(particle5.position.x,particle5.position.y,8);
  ellipse(particle6.position.x,particle6.position.y,14);
  ellipse(particle7.position.x,particle7.position.y,7);
  ellipse(particle8.position.x,particle8.position.y,15);
  ellipse(particle9.position.x,particle9.position.y,6);
  ellipse(particle10.position.x,particle10.position.y,16);
